          ...
          <div className="self-stretch mt-20 max-md:max-w-full">
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
              {[1, 2, 3].map((index) => (
                ...
                >
                  <div className="aspect-square object-contain object-center w-full overflow-hidden max-md:mt-8  border-2 border-[#000] rounded-3xl"></div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="self-stretch mt-20 max-md:max-w-full">
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
              {photos.map((photo, index) => (
                <div key={index} className="...image container styles...">
